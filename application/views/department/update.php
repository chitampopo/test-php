...
<div class="breadcrumbs" id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li>
            <a href="<?= Url::to(['/department/index']) ?>">Danh sách phòng ban</a>
        </li>
        <li class="active">
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-md-8 col-lg-8">
                        ...
                        <?= Html::a('<i class="fa fa-arrow-left" aria-hidden="true"></i> Thoát', \yii\helpers\Url::to(['/department']), ['class' => 'btn btn-sm btn-danger', 'name' => 'btnExit']) ?>
                    </div>
                </div>
            </div>
