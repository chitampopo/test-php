...
$this->title = "Cập nhật tình trạng hôn nhân";
?>
<div class="breadcrumbs" id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li>
            <a href="<?= Url::to(['/marital-status/index']) ?>">Danh sách tình trạng hôn nhân</a>
        </li>
        <li class="active">
            <a href="#">Cập nhật tình trạng hôn nhân</a>
        </li>
    </ul>
</div>
<br>
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-md-8 col-lg-8">
                        ...
                        <?= Html::a('<i class="fa fa-arrow-left" aria-hidden="true"></i> Thoát', \yii\helpers\Url::to(['/marital-status']), ['class' => 'btn btn-sm btn-danger', 'name' => 'btnExit']) ?>
                    </div>
                </div>
            </div>
